...
export default function Geographies() {
  return (
    <AnimatedSection id="geographies" className="wf-geographies position-relative overflow-hidden">
      ...
      <div className="container position-relative" style={{ zIndex: 1 }}>
        <div className="row align-items-center">
          ...
          <div className="col-lg-7 offset-lg-1 mt-4 mt-lg-0">
            <SlideLeft>
              <span className="wf-eyebrow">Geographies</span>
              <h2 className="wf-display text-white mt-2">{francoSection.headline}</h2>
            </SlideLeft>
